...
public class NotesList extends ListActivity {
    ...
    private static ICryptUtils crypto = new CryptUtils();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MatrixCursor matrixCursor = new MatrixCursor(dataColumns);
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            String data = crypto.stringDecrypt(iv, key, salt, cursor.getInt(0), cursor.getString(1));
            matrixCursor.addRow(new Object[]{data, cursor.getInt(0)});
            cursor.moveToNext();
        }
        ...
        SimpleCursorAdapter adapter
                ...
                matrixCursor,                           // The cursor to get items from
                dataColumns,
                viewIDs
        );
